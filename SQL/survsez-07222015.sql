...
DROP TABLE IF EXISTS sm15_responses_answers; 
DROP TABLE IF EXISTS sm15_responses;
...
INSERT INTO sm15_surveys VALUES (NULL,1,'Our First Survey','Description of Survey',NOW(),NOW(),0,0); 
...
INSERT INTO sm15_answers VALUES (NULL,1,'Yes','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,1,'No','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,2,'Yes','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,2,'No','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,2,'Maybe','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,3,'Chocolate','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,3,'Butterscotch','',NOW(),NOW(),0);
INSERT INTO sm15_answers VALUES (NULL,3,'Pineapple','',NOW(),NOW(),0);


CREATE TABLE sm15_responses(
...
INSERT INTO sm15_responses VALUES (NULL,1,NOW());


CREATE TABLE sm15_responses_answers(
...
FOREIGN KEY (ResponseID) REFERENCES sm15_responses(ResponseID) ON DELETE CASCADE
)ENGINE=INNODB;

INSERT INTO sm15_responses_answers VALUES (NULL,1,1,1);
INSERT INTO sm15_responses_answers VALUES (NULL,1,2,5);
INSERT INTO sm15_responses_answers VALUES (NULL,1,3,6);
INSERT INTO sm15_responses_answers VALUES (NULL,1,3,7);
INSERT INTO sm15_responses_answers VALUES (NULL,1,3,8);
